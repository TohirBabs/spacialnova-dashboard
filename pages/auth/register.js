...
const register = () => {
  return (
    <div className="lg:flex font-sec">
      <div className="w-35 xl:max-w-screen-lg bg-pryred">
        <div className="flex content-center items-center justify-center h-full">
          <div className="w-full px-4">
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form>
                  ...
                  <div className="text-center mt-6">
                    <button
                      className="bg-prygreen btn text-white font-bold mr-1 mb-1 w-full ease-linear transition-all duration-150"
                      type="button"
                    >
                      Create Account
                    </button>
            ...
            <div className="flex flex-wrap mt-6 relative">
              ...
              <div className="w-1/2 text-right text-pryblue font-bold text-base">
      ...
      <div className="hidden lg:flex items-center justify-center bg-pryred flex-1 h-screen">
        <div className="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
          <img
            alt="..."
            className="align-middle border-none "
            src="/img/drone plant.png"
          />
        </div>
      </div>
    </div>
